...
TEST(testShowAllFlights, testinginvalidShowAllFlights) {
	...
	EXPECT_STRNE(result[1][0], "2");
	EXPECT_STRNE(result[1][1], "2020-02-01");
	EXPECT_STRNE(result[1][2], "2");
	EXPECT_STRNE(result[1][3], "20");
	EXPECT_STRNE(result[1][4], "3");
	EXPECT_STRNE(result[1][5], "5");
	EXPECT_STRNE(result[1][6], "12000");
	EXPECT_STRNE(result[1][7], "yes");
	EXPECT_STRNE(result[2][0], "3");
	EXPECT_STRNE(result[2][1], "2020-02-02");
	EXPECT_STRNE(result[2][2], "4");
	EXPECT_STRNE(result[2][3], "4");
	EXPECT_STRNE(result[2][4], "8");
	EXPECT_STRNE(result[2][5], "3");
	EXPECT_STRNE(result[2][6], "5600");
	EXPECT_STRNE(result[2][7], "no");
	EXPECT_STRNE(result[3][0], "4");
	EXPECT_STRNE(result[3][1], "2020-02-04");
	EXPECT_STRNE(result[3][2], "3");
	EXPECT_STRNE(result[3][3], "3");
	EXPECT_STRNE(result[3][4], "3");
	EXPECT_STRNE(result[3][5], "2");
	EXPECT_STRNE(result[3][6], "4050");
	EXPECT_STRNE(result[3][7], "no");
	EXPECT_STRNE(result[4][0], "5");
	EXPECT_STRNE(result[4][1], "2020-02-05");
	EXPECT_STRNE(result[4][2], "4");
	EXPECT_STRNE(result[4][3], "1");
	EXPECT_STRNE(result[4][4], "7");
	EXPECT_STRNE(result[4][5], "7");
	EXPECT_STRNE(result[4][6], "13750");
	EXPECT_STRNE(result[4][7], "yes");
	EXPECT_STRNE(result[5][0], "6");
	EXPECT_STRNE(result[5][1], "2020-02-07");
	EXPECT_STRNE(result[5][2], "1");
	EXPECT_STRNE(result[5][3], "18");
	EXPECT_STRNE(result[5][4], "15");
	EXPECT_STRNE(result[5][5], "4");
	EXPECT_STRNE(result[5][6], "7000");
	EXPECT_STRNE(result[5][7], "no");
	EXPECT_STRNE(result[6][0], "5");
	EXPECT_STRNE(result[6][1], "2020-02-05");
	EXPECT_STRNE(result[6][2], "4");
	EXPECT_STRNE(result[6][3], "1");
	EXPECT_STRNE(result[6][4], "7");
	EXPECT_STRNE(result[6][5], "7");
	EXPECT_STRNE(result[6][6], "137540");
	EXPECT_STRNE(result[6][7], "yes");
	EXPECT_STRNE(result[7][0], "7");
	EXPECT_STRNE(result[7][1], "2024-02-08");
	EXPECT_STRNE(result[7][2], "2");
	EXPECT_STRNE(result[7][3], "17");
	EXPECT_STRNE(result[7][4], "20");
	EXPECT_STRNE(result[7][5], "10");
	EXPECT_STRNE(result[7][6], "140400");
	EXPECT_STRNE(result[7][7], "yes");
	EXPECT_STRNE(result[8][0], "8");
	EXPECT_STRNE(result[8][1], "20420-02-08");
	EXPECT_STRNE(result[8][2], "3");
	EXPECT_STRNE(result[8][3], "1");
