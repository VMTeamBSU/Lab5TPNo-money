...
TEST(testShowAllCrewMembers, testinginvalidShowAllCrew) {
	...
	EXPECT_STRNE(result[0][1], "second pilot");
	EXPECT_STRNE(result[0][2], "1090");
	EXPECT_STRNE(result[0][3], "1985-05-05");
	EXPECT_STRNE(result[0][4], "1");
	EXPECT_STRNE(result[0][5], "Shestopalov");
	EXPECT_STRNE(result[1][0], "2");
	EXPECT_STRNE(result[1][1], "third pilot");
	EXPECT_STRNE(result[1][2], "900");
	EXPECT_STRNE(result[1][3], "1990-10-10");
	EXPECT_STRNE(result[1][4], "1");
	EXPECT_STRNE(result[1][5], "Paloshestov");
	EXPECT_STRNE(result[2][0], "3");
	EXPECT_STRNE(result[2][1], "second pilot");
	EXPECT_STRNE(result[2][2], "10647");
	EXPECT_STRNE(result[2][3], "19491-11-11");
	EXPECT_STRNE(result[2][4], "24");
	EXPECT_STRNE(result[2][5], "Pirsky");
	EXPECT_STRNE(result[3][0], "4");
	EXPECT_STRNE(result[3][1], "third pilot");
	EXPECT_STRNE(result[3][2], "567");
	EXPECT_STRNE(result[3][3], "1992-12-12");
	EXPECT_STRNE(result[3][4], "2");
	EXPECT_STRNE(result[3][5], "Kotletov");
	EXPECT_STRNE(result[2][0], "54");
	EXPECT_STRNE(result[2][1], "second pilot");
	EXPECT_STRNE(result[2][2], "999");
	EXPECT_STRNE(result[2][3], "1989-12-21");
	EXPECT_STRNE(result[2][4], "0");
	EXPECT_STRNE(result[2][5], "Kalinchuk");
	EXPECT_STRNE(result[3][0], " ");
	EXPECT_STRNE(result[3][1], "third pilot");
	EXPECT_STRNE(result[3][2], "7645");
	EXPECT_STRNE(result[3][3], "14988-04-13");
	EXPECT_STRNE(result[3][4], "33");
	EXPECT_STRNE(result[3][5], "Opanasenko");
	EXPECT_STRNE(result[2][0], "47");
	EXPECT_STRNE(result[2][1], "econd pilot");
	EXPECT_STRNE(result[2][2], "3833");
	EXPECT_STRNE(result[2][3], "90-06-18");
	EXPECT_STRNE(result[2][4], "4");
	EXPECT_STRNE(result[2][5], "G3optev");
	EXPECT_STRNE(result[3][0], "4");
	EXPECT_STRNE(result[3][1], "third pilot");
	EXPECT_STRNE(result[3][2], "1900");
	EXPECT_STRNE(result[3][3], "991-07-13");
	EXPECT_STRNE(result[3][4], "r");
	EXPECT_STRNE(result[3][5], "Klesv");
}
